...
class StakeMokTokenConfirmation extends StatefulWidget {

  @override
  _StakeMokTokenConfirmationState createState() => _StakeMokTokenConfirmationState();
}

class _StakeMokTokenConfirmationState extends State<StakeMokTokenConfirmation> {
          ...
          child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text('Your token has been staked successfully.',
